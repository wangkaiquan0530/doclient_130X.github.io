/**
  ...
  * @版本    V1.0.0
  * @日期    2018-5-22
  * @概要    这个文件是chipintelli公司的CI112X芯片程序的主函数.
  ******************************************************************************
  * @注意
  *
...
{
    /* 升级串口 */
    UARTPollingConfig(OTA_UPDATE_PORT);/*update port*/
    ...
    /* QFLASH0 初始化*/
    Scu_Setdevice_Reset(HAL_QSPI0_BASE);
    Scu_Setdevice_ResetRelease(HAL_QSPI0_BASE);
    flash_init(QSPI0);
