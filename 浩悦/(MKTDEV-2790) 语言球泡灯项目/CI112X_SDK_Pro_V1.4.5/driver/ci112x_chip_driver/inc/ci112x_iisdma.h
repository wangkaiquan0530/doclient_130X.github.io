 ...
 * @defgroup ci112x_iisdma ci112x_iisdma
 * @brief CI112X芯片iisdma驱动
 * @{
 */
...
void IISDMA_ChannelENConfig(IISDMA_TypeDef* IISDMAx, IISChax iisx, \
                           IISDMA_TXRX_ENx iisdma_txrx_sel, FunctionalState cmd);
void IISDMA_ADDRRollBackINT(IISDMA_TypeDef* IISDMAx, IISChax iisx,\
                           IISDMA_TXRX_ENx iisdma_txrx_sel,FunctionalState cmd);
void IISDMA_ChannelIntENConfig(IISDMA_TypeDef* IISDMAx, IISChax iisx,\
                              IISDMA_TXRX_ENx iisdma_txrx_sel,FunctionalState cmd);
...
void IISxDMA_TXADDRRollbackInterruptClear(IISDMA_TypeDef* IISDMAx, IISChax iisx,\
...
void i2s_dma_straight_to_vad(IIS_TypeDef* iis,uint32_t block_times,uint32_t endroll_addr);
