 ...
 * 
 */
#ifndef _CI112X_LOWPOWER_H_
#define _CI112X_LOWPOWER_H_
 ...
 * @defgroup ci112x_lowpower ci112x_lowpower
 * @brief CI112X芯片电源管理驱动
 * @{
 */
