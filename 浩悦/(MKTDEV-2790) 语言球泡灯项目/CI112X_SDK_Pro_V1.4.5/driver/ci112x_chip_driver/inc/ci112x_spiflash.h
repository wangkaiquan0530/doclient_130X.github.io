...
#ifndef _CI112X_SPIFLASH_H_
#define _CI112X_SPIFLASH_H_
 ...
 * @defgroup ci112x_spiflash ci112x_spiflash
 * @brief CI112X芯片SPIFLASH驱动
 * @{
 */
...
typedef enum
{
    ...
    SPIC_CMD_CODE_QUADINPUTPAGEPROGRAM          = 0x32,     /*!< Quad Input Page Program */
    ...
    SPIC_CMD_CODE_FASTREADDUALOUTPUT            = 0x3b,     /*!< Fast Read Dual Output */
    SPIC_CMD_CODE_FASTREADQUADOUTPUT            = 0x6b,     /*!< Fast Read Quad Output */
    ...
    SPIC_CMD_CODE_READ_UNIQUE_ID                = 0x4b,     /*!< Read Uniaue ID Number */
    SPIC_CMD_CODE_ERASE_SECURITY_REG            = 0x44,     /*!< Erase Security Registers */
    SPIC_CMD_CODE_WRITE_SECURITY_REG            = 0x42,     /*!< Program Security Registers */
    SPIC_CMD_CODE_READ_SECURITY_REG             = 0x48,     /*!< Read Security Registers */
    SPIC_CMD_CODE_WRITE_EXTENDED_ADDR_REG       = 0xC5,     /*!< write extended Registers */
    SPIC_CMD_CODE_READ_EXTENDED_ADDR_REG        = 0xC8,     /*!< read extended Registers */
}spic_cmd_code_t;
