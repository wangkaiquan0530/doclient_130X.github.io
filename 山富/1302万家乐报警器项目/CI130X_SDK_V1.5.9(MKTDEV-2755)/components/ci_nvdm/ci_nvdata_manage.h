...
#define NVDATA_ID_VOICE_TYPE            0x70000001 /*'VOICE_TYPE'*/
#define NVDATA_ID_WAKEUPID              0x70000002 /*'WAKE'*/
#define NVDATA_ID_SSID                  0x70000003 /*'SSID'*/

#define NVDATA_TEST_FLAG                0x70000006 /*'test flag'*/  
