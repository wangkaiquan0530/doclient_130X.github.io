...
// 串口重发时间
#define UART_RESEND_TIME                    1500   //串口数据发送后，1.5秒没收到应答，则会重发一次
#define VOICE_TYPE_DEFAULT                  0      //0=女生，1=男生

#define USE_EXTERNAL_CRYSTAL_OSC             1      //使用外部晶振

//串口2用于 燃气到语音模块通信
#define UART_GAS_ALARM_PROTOCOL_NUMBER (HAL_UART2_BASE) 
#define GAS_ALARM_PLAY_TIME                    8000//报警器间隔播放时间 5+3 间隔5秒 播放3秒
