...
typedef enum
{
    ...
    MSG_CMD_INFO_STATUS_POST_CHANGE,    
...
#define INVALID_FUNCTION_INDEX	(0xFFFF)
...
extern unsigned char gs_ResendCmd;
...
uint8_t voice_type_set(char vol);
